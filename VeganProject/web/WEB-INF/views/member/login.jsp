         ...
         <div class="modal-content">
            <div class="modal-header">
               <img class="modal-header-logo"
                  src="http://localhost:8787/vgan/resources/image/after/vganlogo-1w.png">
               <button type="button" class="close" data-dismiss="modal"
                  aria-hidden="true">x</button>
               <h4 class="modal-title">Sign in</h4>
            </div>
            <div class="modal-body">
               <form action="http://localhost:8787/vgan/member/login" method="post">
               ...
               <p class="hint-text small">
                  <a href="http://localhost:8787/vgan/member/searchmem">Forgot Your Password?</a><a href="http://localhost:8787/vgan/member/searchmem"> / Forgot
                     Your ID?</a>
               </p>
            </div>
            ...
            <div class="modal-header">
               ...
               <form action="http://localhost:8787/vgan/member/join" method="post">
                  <br>
                  <div class="form-group">
